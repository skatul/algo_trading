...
class TestBacktestEngine(unittest.TestCase):
    ...
    def test_execute_buy_order(self):
        ...
        expected_cash = initial_cash - (expected_shares * price * (1 + self.engine.commission))
    ...
    def test_execute_sell_order(self):
        ...
        expected_cash_increase = initial_shares * sell_price * (1 - self.engine.commission)
    ...
    def test_run_backtest(self):
        ...
        expected_keys = ['initial_capital', 'final_capital', 'total_return', 
    ...
    def test_calculate_metrics(self):
        ...
        returns = pd.Series([0.01, -0.0198, 0.0303, 0.0294])  # Returns from portfolio values
    ...
    def test_invalid_signals_handling(self):
        ...
        invalid_data['signal'] = [2, -2, 5, 0, 1, -1, 3, 0, 0, -1]  # Invalid signal values
    ...
    def test_insufficient_cash_handling(self):
        ...
        expensive_data['close'] = expensive_data['close'] * 10000  # Very expensive stock
