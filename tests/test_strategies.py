...
class TestBaseStrategy(unittest.TestCase):
    ...
    def test_calculate_performance_metrics(self):
        ...
        self.strategy.trades = [
            {'pnl': 10, 'pnl_percent': 10, 'entry_date': datetime(2023, 1, 1), 'exit_date': datetime(2023, 1, 2)},
            {'pnl': -5, 'pnl_percent': -5, 'entry_date': datetime(2023, 1, 3), 'exit_date': datetime(2023, 1, 4)},
            {'pnl': 15, 'pnl_percent': 15, 'entry_date': datetime(2023, 1, 5), 'exit_date': datetime(2023, 1, 6)}
        ]
...
class TestMovingAverageCrossoverStrategy(unittest.TestCase):
    ...
    def test_calculate_indicators(self):
        ...
        pd.testing.assert_series_equal(result['sma_short'], expected_short_ma, check_names=False)
